...
impl DiskInode {
    ...
    /// 计算传入的 size 需要的 block 数量，包括 inode block 和 data block
        ...
        get_block_cache(self.indirect2 as usize, Arc::clone(block_device))
            ...
            .modify(0, |indirect2: &mut IndirectBlock| {
                while (a0 < a1) || (a0 == a1 && b0 < b1) {
                    ...
                    // 填充当前 indirect2 的 a0 层对应的 indirect1
    ...
    /// 从 buf 中写入数据到 disk inode offset
    /// 需要调用者保证能够完全写入
    pub fn write_at(
        &mut self,
        offset: usize,
